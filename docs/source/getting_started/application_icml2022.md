...
>>> fonts.icml2022()
{'text.usetex': False, 'font.serif': ['Times New Roman', 'Times', 'TeX Gyre Termes', 'Nimbus Roman'], 'font.sans-serif': ['Helvetica', 'Helvetica Neue', 'TeX Gyre Heros', 'Nimbus Sans', 'Nimbus Sans L'], 'font.family': 'serif', 'mathtext.fontset': 'cm'}
