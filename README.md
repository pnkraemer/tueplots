...
[![gh-actions](https://img.shields.io/github/actions/workflow/status/pnkraemer/tueplots/ci.yaml?branch=main)](https://github.com/pnkraemer/tueplots/actions?query=workflow%3Aci)
